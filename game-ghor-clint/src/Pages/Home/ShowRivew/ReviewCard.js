...
const ReviewCard = ({ review }) => {
    ...
    return (
        <figure className="max-w-screen-md my-20 shadow-xl p-10">
            ...
            <figcaption className="flex items-end mt-6 space-x-3">
                <div className="flex  divide-x-2 divide-gray-300 dark:divide-gray-700">
                    <cite className="pr-3 font-medium text-gray-900 dark:text-white">{name}</cite>
                    <cite className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">{email}</cite>
                </div>
            </figcaption>
        </figure>
    );
